...
CREATE TABLE level_station_values (id serial PRIMARY KEY, label varchar(50), lat double precision, long double precision, station int, typicalmin double precision, typicalmax double precision);

DROP TABLE IF EXISTS temptimecsv;
DROP TABLE IF EXISTS templevelcsv;
DROP TABLE IF EXISTS tempstationcsv;
DROP TABLE IF EXISTS templevelstationscsv;
...
CREATE TABLE templevelstationcsv (id serial PRIMARY KEY, label varchar(50), lat double precision, long double precision, stationref varchar(50), typicalmin double precision, typicalmax double precision);
COMMIT;
